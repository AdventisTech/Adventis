  ...
  assetDetails: async (req, res) => {
    try {
      const { Name, Projecttimefrom1, Projecttimeto1, Projecttimefrom2,Projecttimeto2,
        ...
        Project4id,Project5id,userid,Department,status,statusdescription} = req.body;
      const result = new assetModel({
        ...
        Project4id:Project4id,Project5id:Project5id,userid:userid,Department:Department,status:status,statusdescription:statusdescription
      });
      await result.save();
