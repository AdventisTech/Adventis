...
exports.uploadAttendance = async (req, res) => {
  try {
    console.log('req.body', req.body); // Check if req.body contains expected data
    ...
    console.log('result', result); // Check if conversion to JSON is successful
    ...
    console.log('attendanceData', attendanceData); // Check if mapped data is correct
