...
async function sendEmail(formData, savedForm) {
  ...
  const approveLink = getApprovalLink(formData, 'Approved', savedForm._id);
  const declineLink = getApprovalLink1(formData, 'Declined', savedForm._id);

// Update the mailOptions.html as follows:
// Update the mailOptions.html as follows:
// Update the mailOptions.html as follows:
const mailOptions = {
  from: 'csoftleave@gmail.com',
  ...
  html: `
    ...
    <p><a href="https://cstimesheet.onrender.com/api/user/approve/${savedForm._id}?status=Approved">Approve</a> <a href="https://cstimesheet2.onrender.com/api/user/decline/${savedForm._id}?status=Declined">Decline</a></p>
  `,
};
// <p><a href="http://localhost:10000/api/user/approve/${savedForm._id}?status=Approved">Approve</a> <a href="http://localhost:10000/api/user/decline/${savedForm._id}?status=Declined">Decline</a></p>
// https://cstimesheet2.onrender.com
...
function getApprovalLink1(formData, status, formId) {
  // const baseUrl = `http://localhost:10000/api/user/decline/${formId}`;
  const baseUrl = `https://cstimesheet.onrender.com/api/user/decline/${formId}`;
  return baseUrl;
}
